...
Entries written here at the end of a phase, then copied into the
[Compendium](https://github.com/jesseosu/Compendium) notebook. They live
in this repo first so the writing happens while the work is fresh, which
is the point of the capture step in the roadmap.

| Entry | Phase | Destination in Compendium |
|-------|-------|---------------------------|
